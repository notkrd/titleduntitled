 ...
 * with the rest of it)
 *
 *-- Returning 5 years later: I was 19. It was my first try at digital
 *-- lit. Some I excuse as the work of "trying on thoughts," some I don't.
 *--
 *-- I believe I understood the faint irony of using these poets but 
 *-- failed to work with their cliche. Only Stevens is faintly defensible. 
 *-- But none of that matters, not in the scheme of things, we all know.
 *--
 *-- I wish I could not have included the following poem, because Pablo
 *-- Neruda was a rapist. He wrote it lyrically in his autobiography or he
 *-- might have died with his rape, but no one really noticed, for decades
 *-- it seems. You see, he wrote his rape (of a Sri Lankan woman, where he
 *-- was ambassador) in the way he wrote his poetry, unrepentant except to
 *-- turn the mood as a shift of register. She was in a position, by
 *-- language, class & caste, asymmetry of power, incapable, literally,
 *-- of speech as a subject. And then, towards the end of his life, he
 *-- wrote again his rape (after no one asked) in a way that acknowledges
 *-- irrelevant shame but reenacts his, her society's, literary criticism's
 *-- denial of her, who I do assume real, humanity. I heard about it in my 
 *-- Spanish class and, weirdly for its commonality, couldn't read that 
 *-- week (I admit this is a performative morality).
 *--
 *-- The poem came after the project. I was not intensely or particularly
 *-- a fan. But it was the schematic of my essay (this): it was talking
 *-- about the (literal) content I was talking about, in a totally
 *-- different rhetoric, well or badly effectively irrelevant. I will
 *-- write about sexual violence here not because I have yet done the work
 ...
 *
 * -- I genuinely do not whether my experience, my life, licenses me
 * -- to or to not write about certain violences (because, of course,
 * -- it matters); the experiences are all neither/and, both/or. I will
 * -- Everything I loved here I hate (full analogy between code and
 * -- language; lyricized innuendo; certain old-boy poets; logicism). I
 * -- tell myself I will not let myself love things without knowing why
 * -- I love things, but I continue to become fascinated by, immersed 
 * -- in things, without seriously sustaining a critical thought about
 * -- why I so want to immerse in it, what I am trying to go into and
 * -- away from.
 */

% Now, sitting behind your backyard
% window, with an extra page accidentally printed - you get a pencil,
% and start finding the bird's shape. Taking out the tin khit
...
% -- I do not reject my end-of-teenage syntax. I detect an ear in it.
